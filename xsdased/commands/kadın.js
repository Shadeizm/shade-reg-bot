...
.setColor("RANDOM")
.setDescription(`Kayıt olan kullanıcının ismi \`${ayarlar.tag} ${isim} ${ayarlar.sembol} ${yaş}\` olarak değiştirildi ve <@&${ayarlar.kadınRol1}> rolü verildi!`)
